...
int main(/*int argc, char* argv[]*/)
{
  ...
  params.Set("offscreen", true);

  // Create OpenGL window in single line
  pangolin::CreateWindowAndBind("SimpleMultiDisplayOffscreen", 640, 480, params);
  ...
  pangolin::SaveWindowOnRender("window");
    ...
    d_cam1.SaveOnRender("cube1");

    d_cam2.Activate(s_cam2);
    pangolin::glDrawColouredCube();
    d_cam2.SaveOnRender("cube2");
