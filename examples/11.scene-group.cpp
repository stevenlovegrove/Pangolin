...
int main( int argc, char** argv )
{
    ...
    // group some objects
    auto group1 = scene->addInSceneAt( DrawnGroup::Create({
        .children = {axis, star, square},
    }), sophus::SE3d::trans(5.0, 0.0, 1.0));

    auto group2 = scene->addInSceneAt( DrawnGroup::Create({
        .children = {axis, heart},
    ...
    Var<double>::Attach("group1-x", group1->pose.parent_from_drawable.translation().x(), -10.0, 10.0);
    Var<double>::Attach("group1-y", group1->pose.parent_from_drawable.translation().y(), -10.0, 10.0);
