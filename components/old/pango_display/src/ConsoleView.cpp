    ...
    animation_speed(0.2)
{
  ...
  Var<Colour>::Attach(
      "pango.console.colours.Cmd", line_colours[ConsoleLineTypeCmd]);
  Var<Colour>::Attach(
      "pango.console.colours.CmdOptions",
      line_colours[ConsoleLineTypeCmdOptions]);
  Var<Colour>::Attach(
      "pango.console.colours.Stdout", line_colours[ConsoleLineTypeStdout]);
  Var<Colour>::Attach(
      "pango.console.colours.Stderr", line_colours[ConsoleLineTypeStderr]);
  Var<Colour>::Attach(
      "pango.console.colours.Output", line_colours[ConsoleLineTypeOutput]);
  Var<Colour>::Attach(
      "pango.console.colours.Help", line_colours[ConsoleLineTypeHelp]);
