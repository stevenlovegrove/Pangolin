...
namespace pangolin {
void PrintRegistryHelp( const pangolin::FactoryRegistry* registry, const std::string& scheme = "", HelpVerbosity level = HelpVerbosity::SUMMARY, std::ostream& output = std::cerr)
{
...
//            pangolin::FactoryUseInfo help_data = f.Help();
