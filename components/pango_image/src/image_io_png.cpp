...
void PNGAPI PngWarningsCallback(
...
{
#ifdef HAVE_PNG
  // so First, we validate our stream with the validate function I just
  // mentioned
    ...
    int zlib_compression_level)
{
  ...
  // Write header
  png_set_IHDR(
      png_ptr, info_ptr, (png_uint_32)image.width(),
      (png_uint_32)image.height(), bit_depth, colour_type, PNG_INTERLACE_NONE,
