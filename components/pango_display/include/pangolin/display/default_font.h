...
// tex_w, tex_h are the atlas dimensions. The method will throw if tex_w and tex_h are too small to fit the font
// use_alpha_font - choose to render as a bitmap with alpha channel, or if false, as an SDF.
